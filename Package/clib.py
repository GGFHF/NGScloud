...
'''
This source contains the general functions and classes used in NGScloud
...
def view_file(file, text):
    ...
    print('*' * 20 + '   ' + file + '   ' + '*' * 20)
    try:
        with open(file, mode='r', encoding='utf-8') as file_id:
            print(file_id.read())
    except:
...
if __name__ == '__main__':
     print('This source contains the general functions and classes used in NGScloud software package used in console mode.')
     sys.exit(0)
